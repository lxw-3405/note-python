...
def author():
    showinfo('作者信息','本软件由lsj完成')

def about():
    showinfo('版权信息.Copyright','本软件版权归属lsj')
...
def search():
    ...
    button1 = Button(topsearch, text='查找') #, command=genSearch
